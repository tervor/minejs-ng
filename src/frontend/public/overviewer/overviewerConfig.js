var overviewerConfig = {
    ...
    'CONST': {
        ...
        'image': {        		// Various images used for markers and stuff.
            'defaultMarker':    '/overviewer/signpost.png',
            'signMarker':       '/overviewer/signpost_icon.png',
            'compass':          '/overviewer/compass.png',
    ...
    'map': {    			// General map settings.
        ...
        'center':       [0,0,0], /// Center on this point, in world coordinates. Should be an array, ex: [0,0,0]
